dbSource = db.getSiblingDB("tpch_original");
dbDest = db.getSiblingDB("jointpch");
dbDest.deals.drop();
...
var elapsed = end_time.getTime() - start_time
print("Elapsed " + elapsed + " | In seconds: " +  (elapsed / 1000));